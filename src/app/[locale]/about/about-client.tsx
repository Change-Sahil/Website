...
export default function AboutClient() {
  ...
  const hasPracticeSection =
    !!t("practiceTitle", { defaultValue: "" }) && practiceItems.length > 0;

  const hasTestimonialsSection =
    !!t("testimonialsTitle", { defaultValue: "" }) && testimonials.length > 0;
          ...
          <div className="lg:col-span-5">
            <div className="panel overflow-hidden p-0">
              <div className="relative h-[420px] w-full md:h-[520px]">
                <Image
                  src={t("heroImage", {
                    defaultValue: "/seref-sahil-change-werkstatt.jpg"
                  })}
          ...
          <div className="lg:col-span-5">
            <div className="panel h-full">
              ...
              <p className="mt-4 text-sm text-slate-600">
                ...
                >
                  {t("linkedInLabel", {
                    defaultValue: "LinkedIn-Profil ansehen"
                  })}
                </a>
              </p>
            </div>
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    {item.text && (
                      <p className="mt-3 text-sm leading-7 text-slate-700 md:text-[0.98rem]">
                        {item.text}
                      </p>
                    )}
                  </div>
